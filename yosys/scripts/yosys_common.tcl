...
set sv_flist   "src/mcu-soc.flist"
set out_dir    out
set tmp_dir    tmp
set rep_dir    reports
...
set proj_name  [expr {[info exists ::env(PROJ_NAME)]  ? $::env(PROJ_NAME)  : "mcu"}]
set top_design [expr {[info exists ::env(TOP_DESIGN)] ? $::env(TOP_DESIGN) : "mcu-soc"}]
